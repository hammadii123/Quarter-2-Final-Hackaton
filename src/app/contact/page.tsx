...
const page = () => {
  return (
    <div className='flex flex-col items-center'>
        ...
        <div className="flex px-4  py-3 rounded-md md:w-[30%] border-2 border-text-secondary-gray mt-4 md:justify-between space-x-3">
            <input className=" bg-white focus-visible:outline-none md:w-[85%] w-100 " type="text" placeholder="What can we help you with?" name="" id="" />
            <Image  src={searchIcon} alt="wishlist" width={25} />
        </div>
        <div className="md:grid md:grid-cols-12 flex flex-col px-8 md:px-16 py-8 bg-white text-gray-800">
            <div className='md:col-span-9 md:border-r-[1.3px] pr-4 border-text-secondary-gray'>
